...
function printTable(mm, yy) {
	...
	var res = "";
	res += ('<table class="thang table-calendar" border="2" cellpadding="1" cellspacing="1" width="'+PRINT_OPTS.tableWidth+'">\n');
	res += printHead(mm, yy);
	for (i = 0; i < 6; i++) {
		res += ("<tr>\n");
		for (j = 0; j < 7; j++) {
...
function getPrevMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'" class="btn"><span class="fa fa-angle-left"></span></a>';
}
...
function getNextMonthLink(mm, yy) {
	...
	return '<a class="btn" href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'"><span class="fa fa-angle-right"></span></a>';
}

function getPrevYearLink(mm, yy) {
	//return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><img src="left2.gif" width=16 height=12 alt="PrevYear" border=0></a>';
	return '<a class="btn" href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><span class="fa fa-angle-double-left"></span></a>';
}

function getNextYearLink(mm, yy) {
	//return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><img src="right2.gif" width=16 height=12 alt="NextYear" border=0></a>';
	return '<a class="btn " href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><span class="fa fa-angle-double-right"></span></a>';
}
...
function printHead(mm, yy) {
	...
	res += ('<thead><th colspan="2" class="navi-l">'+getPrevYearLink(mm, yy)+''+getPrevMonthLink(mm, yy)+'</th>\n');
	//res += ('<td colspan="1" class="navig"><a href="'+getPrevMonthLink(mm, yy)+'"><img src="left1.gif" alt="Prev"></a></td>\n');
	res += ('<th colspan="3" class="tenthang" >'+monthName+'</th>\n');
	//res += ('<td colspan="1" class="navi-r"><a href="'+getNextMonthLink(mm, yy)+'"><img src="right1.gif" alt="Next"></a></td>\n');
	res += ('<th colspan="2" class="navi-r">'+getNextMonthLink(mm, yy)+''+getNextYearLink(mm, yy)+'</th></thead>\n');
	//res += ('<tr><td colspan="7" class="tenthang"><a href="'+getNextMonthLink(mm, yy)+'"><img src="right.gif" alt="Next"></a></td></tr>\n');
	res += ('<tr class="thu" onClick="alertAbout();">\n');
	for(var i=0;i<=6;i++) {
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	...
	res += ('<td class="'+cellClass+' '+solarClass+'"');
	if (lunarDate != null) res += (' title="'+getDayName(lunarDate)+'" ');
	res += (' style=color:'+solarColor+'>'+solarDate+'</div> <div class="check-action"><input class="check" type="checkbox"> <span class="name"></span></div>  <div class="'+lunarClass+'">'+lunar+'</div></td>\n');
	return res;
}
