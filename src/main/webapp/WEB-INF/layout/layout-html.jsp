...
<head>
	<title class="title">CSDL NÂNG CAO - NHÓM 1</title>
	<meta charset="utf-8" />
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/custom-uiux/nucleo/outline/css/style.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/custom-uiux/ap8/css/style.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/custom-uiux/style.css?v=2">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/style-dancu/css/style.css">
...
<body class="no-js" lang="vi" ng-app="myApp" aaa="<b>imdam</b>">
	...
	<tiles:insertAttribute name="header-html"></tiles:insertAttribute>
	<tiles:insertAttribute name="navbar-html"></tiles:insertAttribute>

	<div class="main-content mscrollable">
	...
	<%@ include file="/WEB-INF/_components/menu/menu-js.jsp" %>
